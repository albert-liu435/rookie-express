package com.rookie.bigdata.yto.util;
...
public class HttpUtil {
    ...
    public static String postJson(String interfaceUrl, String json) throws IOException {
        return postJson(interfaceUrl,new HashMap<String,String>(),json);
